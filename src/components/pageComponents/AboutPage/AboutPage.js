...
const AboutPage = () => {
  ...
  return (
    <div className="aboutpage-root">
      {/* ✅ SEO tags for AboutPage */}
      <Helmet>
        <title>About UniPath | Explore Campus Cultures & Student Life</title>
        <meta
          name="description"
          content="Learn about UniPath’s mission to connect students through diverse South African cultures. Explore Zulu, Sotho, Sepedi, Setswana, Xhosa, Tsonga, Venda, English, and Afrikaans perspectives on university life."
        />
        <meta
          name="keywords"
          content="UniPath, about UniPath, student culture, Zulu students, Sotho students, South African university diversity, campus life, first year tips"
        />
        <meta name="author" content="UniPath Team" />
        <meta property="og:title" content="About UniPath" />
        <meta
          property="og:description"
          content="Discover how UniPath celebrates cultural diversity and student success across South African universities."
        />
      ...
      <div className="aboutpage-container">
        <header className="aboutpage-header">
          <h1 className="aboutpage-title">About UniPath</h1>
          <p className="aboutpage-description">
            Explore the university environment and its surrounding communities with guidance that
            illuminates diverse cultural backgrounds you may encounter.
          </p>
        </header>
            ...
            .map((culture) => (
              <div key={culture} className="aboutpage-culture-card">
                <button
                  ...
                  className={`aboutpage-culture-btn${
                    expandedCategory === culture ? " expanded" : ""
                  }`}
                >
